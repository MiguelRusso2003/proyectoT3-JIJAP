...
<body class="bg-dark">
    ...
    <div id="body" class="rounded margin-left-width" style="background-image:url(img/bandera.jpg); background-size:cover;background-attachment: fixed; ">
        ...
        <div class="bg-white-trans rounded">
            <div class="container">
                ...
                <div class="d-md-flex text-center justify-content-between align-items-center">
                    <div class="d-md-flex d-block">
                        <img src="icons/mueble.svg" style="width: 70px;"><hr class="d-md-none w-25 mx-auto border-primary border"><div class="vr mx-3 d-md-block d-none border-primary"></div>
                        <h1 class="display-5">Bienes Muebles </h1>
                    </div>
                    <form action="formBnMu.php" method="post">
                        <button type="button" class="btn mt-3 mt-md-0 btn-outline-success border-3" data-bs-toggle="modal" data-bs-target="#exampleModal">+ Nuevo Registro</button>
                    </form>
                </div>
