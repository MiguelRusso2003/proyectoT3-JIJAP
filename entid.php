...
<body class="bg-dark">
    ...
    <div id="body" class="shadow margin-left " style="border-radius: 10px; background-image : url(img/img3.jpg); background-size : cover">
        ...
        <div class="container-fluid text-center rounded bg-dark-trans align-items-center h-100">
            ...
            <div>
                <h1 class="display-3 text-light">Entidades</h1>
            </div>
