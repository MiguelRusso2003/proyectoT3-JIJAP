...
<body class="bg-dark">
    ...
    <div id="body" class="rounded margin-left" style="background-image:url(img/bg-parke2.jpg); background-size:cover;background-attachment: fixed;">
        ...
        <div class="container-fluid bg-white-trans rounded">
            <div class="container">
                ...
                <div class="d-flex justify-content-between align-items-center px-3">
                    <h1 class="display-4"><img src="icons/graduacion.svg"  style="width: 70px; height:70px"> | Alumnos </h1>
