...
<body class="bg-dark">
    ...
    <div id="body" class="rounded margin-left-width" style="background-image:url(img/bg-personal.jpg); background-size:cover; background-attachment: fixed;">
            ...
            <div class="container">
                ...
                <div class="d-md-flex text-center justify-content-between align-items-center">
                    <div class="d-md-flex d-block">
                        <img src="icons/personal.svg" style="width: 70px;"><hr class="d-md-none w-25 mx-auto border-primary border"><div class="vr mx-3 d-md-block d-none border-primary"></div>
                        <h1 class="display-5">Personal </h1>
                    </div>
