<?php
/*
notas para bootstrap: Espaciados de margin y padding.
 ...
 iconos para sweetalert2: success (✅), error (❌), warning (⚠️), info(ℹ️), question (❔).
*/
?>
<!-- Ejemplo para implementar Galeria con Bootstrap -->
<!doctype html>
...
<link href="../styles/bootstrap.min.css" rel="stylesheet">
  ...
  <body>
    <svg xmlns="../icons/bars.svg" class="d-none">
